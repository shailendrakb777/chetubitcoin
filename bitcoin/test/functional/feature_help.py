...
"""Verify that starting h2hcoin with -h works as expected."""

from test_framework.test_framework import H2hcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(H2hcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start h2hcoin with -h for help text")
        ...
        self.log.info("Start h2hcoin with -version for version information")
        ...
        self.log.info("Start h2hcoind with -fakearg to make sure it does not start")
