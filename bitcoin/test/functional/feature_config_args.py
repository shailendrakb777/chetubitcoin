...
class ConfArgsTest(H2hcoinTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        with open(os.path.join(self.nodes[0].datadir, 'h2hcoin.conf'), 'a', encoding='utf-8') as conf:
    ...
    def run_test(self):
        ...
        conf_file = os.path.join(default_data_dir, "h2hcoin.conf")
        ...
        # Temporarily disabled, because this test would access the user's home dir (~/.h2hcoin)
