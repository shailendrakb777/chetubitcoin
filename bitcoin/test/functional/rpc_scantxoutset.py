#!/usr/bin/env python3
# Copyright (c) 2018-2019 The H2hcoin Core developers
...
class ScantxoutsetTest(H2hcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Note that all amounts in the UTXO set are powers of 2 multiplied by 0.001 H2H, so each amounts uniquely identifies a subset.
