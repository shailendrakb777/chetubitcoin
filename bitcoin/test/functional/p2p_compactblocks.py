#!/usr/bin/env python3
# Copyright (c) 2016-2019 The H2hcoin Core developers
...
# TestP2PConn: A peer we use to send messages to h2hcoind, and store responses.
...
class CompactBlocksTest(H2hcoinTestFramework):
    ...
    # This test actually causes h2hcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that h2hcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for h2hcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # h2hcoind will not send blocktxn responses for blocks whose height is
