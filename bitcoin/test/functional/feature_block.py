...
class FullBlockTest(H2hcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure h2hcoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure h2hcoind isn't accepting b28
        ...
        # h2hcoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the h2hcoin code has custom code which does so);
