...
// h2hcoin includes.
#include <..\src\script\h2hcoinconsensus.h>
...
int main()
{
    std::cout << "h2hcoinconsensus version: " << h2hcoinconsensus_version() << std::endl;
    ...
    auto op0Result = h2hcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, h2hcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
