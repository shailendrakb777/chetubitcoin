...
H2hcoin Core has an internal benchmarking framework, with benchmarks
for cryptographic algorithms (e.g. SHA1, SHA256, SHA512, RIPEMD160), as well as the rolling bloom filter.

Running
---------------------
After compiling h2hcoin-core, the benchmarks can be run with:

    src/bench/bench_h2hcoin
...
VerifyScriptBench, 5, 6300, 9.02493, 0.000285566, 0.000289334, 0.000286175
```
