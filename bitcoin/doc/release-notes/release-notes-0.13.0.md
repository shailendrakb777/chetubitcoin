H2hcoin Core version 0.13.0 is now available from:

  <https://h2hcoin.org/bin/h2hcoin-core-0.13.0/>
...
- Adding `dbcache=100` in h2hcoin.conf
...
For example:
    ...
    $ src/h2hcoin-cli -stdin walletpassphrase
    mysecretcode
    120
...
Various code modernizations have been done. The H2hcoin Core code base has
...
compatible peers.
[BIP 152](https://github.com/h2hcoin/bips/blob/master/bip-0152.mediawiki)
...
HD wallets are incompatible with older versions of H2hcoin Core.

[Pull request](https://github.com/h2hcoin/h2hcoin/pull/8035/files), [BIP 32](https://github.com/h2hcoin/bips/blob/master/bip-0032.mediawiki)
...
141](https://github.com/h2hcoin/bips/blob/master/bip-0141.mediawiki), [BIP
143](https://github.com/h2hcoin/bips/blob/master/bip-0143.mediawiki), [BIP
144](https://github.com/h2hcoin/bips/blob/master/bip-0144.mediawiki), and [BIP
145](https://github.com/h2hcoin/bips/blob/master/bip-0145.mediawiki) are
finished and included in this release.  However, BIP 141 does not yet specify
activation parameters on mainnet, and so this release does not support segwit
use on mainnet.  Testnet use is supported, and after BIP 141 is updated with
proposed parameters, a future release of H2hcoin Core is expected that
...
Witness)] (https://github.com/h2hcoin/bips/blob/master/bip-0141.mediawiki).
...
(https://github.com/h2hcoin/bips/blob/master/bip-0141.mediawiki) for additional
details.)
...
The two phases are distinct in the H2hcoin-Qt GUI. During the first one,
...
- The optional new p2p message "feefilter" is implemented and the protocol
  ...
  feerate. [BIP 133](https://github.com/h2hcoin/bips/blob/master/bip-0133.mediawiki)
...
65](https://github.com/h2hcoin/bips/blob/master/bip-0065.mediawiki)

  - OP_NOP3 has been renamed to OP_CHECKSEQUENCEVERIFY by [BIP 
112](https://github.com/h2hcoin/bips/blob/master/bip-0112.mediawiki)
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](https://github.com/h2hcoin/h2hcoin/pull/7762).
...
- #7550 `8b958ab` Input-from-stdin mode for h2hcoin-cli (laanwj)
...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use H2H/kB (MarcoFalke)
...
- #7613 `3798e5d` Add autocomplete to h2hcoin-qt's console window (GamerSg)
...
- #7636 `fb0ac48` Add h2hcoin address label to request payment QR code (makevoid)
- #8231 `760a6c7` Fix a bug where the SplashScreen will not be hidden during startup (jonasschnelli)
- #8256 `af2421c` BUG: h2hcoin-qt crash (fsb4000)
- #8257 `ff03c50` Do not ask a UI question from h2hcoind (sipa)
- #8288 `91abb77` Network-specific example address (laanwj)
- #7707 `a914968` UI support for abandoned transactions (jonasschnelli)
- #8207 `f7a403b` Add a link to the H2hcoin-Core repository and website to the About Dialog (MarcoFalke)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for h2hcoind procs (MarcoFalke)
...
- #8164 `0f24eaf` [H2hcoin-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)
...
- #7744 `d8e862a` test_framework: detect failure of h2hcoind startup (laanwj)
...
- #7975 `fc23fee` Update h2hcoin-core GitHub links (MarcoFalke)
