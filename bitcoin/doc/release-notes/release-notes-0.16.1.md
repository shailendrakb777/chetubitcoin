H2hcoin Core version 0.16.1 is now available from:

  <https://h2hcoincore.org/bin/h2hcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting h2hcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure h2hcoind processes are cleaned up when tests end (sdaftuar)
