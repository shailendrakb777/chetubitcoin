H2hcoin Core version 0.9.4 is now available from:

  https://h2hcoin.org/bin/0.9.4/
...
this update is incompatible with the H2hcoin system and could lead to consensus
forks.

H2hcoin Core released binaries from https://h2hcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~h2hcoin/+archive/ubuntu/h2hcoin
- A third-party or self-compiled H2hcoin Core

upgrade to H2hcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
