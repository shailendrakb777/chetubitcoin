H2hcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/h2hcoin/files/H2hcoin/h2hcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the H2hcoin
...
New/changed settings (command-line or h2hcoin.conf file)
--------------------------------------------------------
