H2hcoin Core version *0.14.3* is now available from:

  <https://h2hcoin.org/bin/h2hcoin-core-0.14.3/>
...
H2hcoin Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
...
- #10451 `3612219` contrib/init/h2hcoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
