H2hcoin Core version 0.13.2 is now available from:

  <https://h2hcoin.org/bin/h2hcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update h2hcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow h2hcoin-tx to create v2 transactions (btcdrak)
