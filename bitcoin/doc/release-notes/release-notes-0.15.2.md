H2hcoin Core version *0.15.2* is now available from:

  <https://h2hcoincore.org/bin/h2hcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in h2hcoin-tx (TheBlueMatt)
