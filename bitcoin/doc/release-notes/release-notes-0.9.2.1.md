H2hcoin Core version 0.9.2.1 is now available from:

  https://h2hcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 H2H to 0.01 H2H
...
- Fix "Start h2hcoin on system login"
