H2hcoin Core version 0.10.4 is now available from:

  <https://h2hcoin.org/bin/h2hcoin-core-0.10.4/>
...
- #6953 `43c2789` Split h2hcoin-tx into its own package
- #6953 `dfe0d4d` Include h2hcoin-tx binary on Debian/Ubuntu
