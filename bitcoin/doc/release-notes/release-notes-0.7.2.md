H2hcoin version 0.7.2 is now available from:
  http://sourceforge.net/projects/h2hcoin/files/H2hcoin/h2hcoin-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused H2hcoin-Qt to crash on Windows when exiting.
