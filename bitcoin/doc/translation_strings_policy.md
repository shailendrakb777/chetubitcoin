...
This document provides guidelines for internationalization of the H2hcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `h2hcoin_en.ts` remains unchanged.
