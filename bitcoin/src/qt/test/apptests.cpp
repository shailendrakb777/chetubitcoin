...
//! Entry point for H2hcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &H2hcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for H2hcoinGUI tests.
void AppTests::guiTests(H2hcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &H2hcoinGUI::consoleShown, this, &AppTests::consoleTests);
