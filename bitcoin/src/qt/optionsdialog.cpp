    ...
    mapper(nullptr)
{
    ...
    ui->h2hcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->h2hcoinAtStartup);
    ...
    ui->h2hcoinAtStartup->setToolTip(ui->h2hcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->h2hcoinAtStartup->setText(ui->h2hcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openH2hcoinConfButton->setToolTip(ui->openH2hcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new H2hcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->h2hcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openH2hcoinConfButton_clicked()
{
