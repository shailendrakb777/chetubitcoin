...
#ifndef H2HCOIN_QT_H2HCOINUNITS_H
#define H2HCOIN_QT_H2HCOINUNITS_H
...
/** H2hcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class H2hcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit H2hcoinUnits(QObject *parent);

    /** H2hcoin units.
      @note Source: https://en.h2hcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        H2H,
...
typedef H2hcoinUnits::Unit H2hcoinUnit;

#endif // H2HCOIN_QT_H2HCOINUNITS_H
