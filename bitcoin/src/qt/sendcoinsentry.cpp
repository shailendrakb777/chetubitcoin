    ...
    platformStyle(_platformStyle)
{
    ...
    // normal h2hcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying h2hcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &H2hcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
