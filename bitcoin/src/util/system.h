 ...
 */
#ifndef H2HCOIN_UTIL_SYSTEM_H
#define H2HCOIN_UTIL_SYSTEM_H
...
extern const char * const H2HCOIN_CONF_FILENAME;
...
{
    std::string s = strprintf("h2hcoin-%s", name);
