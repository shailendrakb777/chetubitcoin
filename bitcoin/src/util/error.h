// Copyright (c) 2010-2018 The H2hcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef H2HCOIN_UTIL_ERROR_H
#define H2HCOIN_UTIL_ERROR_H
 ...
 *
 * Error types defined here can be used in different parts of the h2hcoin
