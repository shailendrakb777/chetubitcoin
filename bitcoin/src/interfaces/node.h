...
#ifndef H2HCOIN_INTERFACES_NODE_H
#define H2HCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a h2hcoin node (h2hcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // H2HCOIN_INTERFACES_NODE_H
