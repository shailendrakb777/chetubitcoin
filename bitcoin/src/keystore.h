...
#ifndef H2HCOIN_KEYSTORE_H
#define H2HCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/h2hcoin/bips/blob/master/bip-0013.mediawiki
