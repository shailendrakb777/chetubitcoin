...
static void SetupH2hcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " h2hcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  h2hcoin-tx [options] <hex-tx> [commands]  Update hex-encoded h2hcoin transaction\n" +
            "or:     h2hcoin-tx [options] -create [commands]   Create hex-encoded h2hcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded h2hcoin transaction
