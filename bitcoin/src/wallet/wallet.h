...
#ifndef H2HCOIN_WALLET_WALLET_H
#define H2HCOIN_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! h2hcoin from opening the wallet, thinking it was newly created, and
...
public:
     ...
     * on this h2hcoin node, and set to 0 for transactions that were created
