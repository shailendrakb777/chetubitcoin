...
#ifndef H2HCOIN_TEST_SCRIPTNUM10_H
#define H2HCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from H2hcoin Core 0.10.0, for cross-comparison.
 */
public:
